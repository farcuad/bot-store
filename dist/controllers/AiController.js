...
function buildSystemPrompt(nombreNegocio, respuestasInfo, customPrompt) {
...
export const generarRespuestaBot = async (historial, nombreNegocio, respuestasInfo, instruccionExtra, customPrompt) => {
    try {
